...
<div class="cbx-chota wpnextpreviouslink-page-wrapper wpnextpreviouslink-setting-wrapper" id="wpnextpreviouslink-setting">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2></h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="postbox">
                    <div class="inside setting-form-warp">
